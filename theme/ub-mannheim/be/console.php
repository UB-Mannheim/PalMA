...
This web application shows all PalMA stations of the Library Section Schloss Ehrenhof.
...
<title>Bibliotheksbereich Schloss Ehrenhof &ndash; PalMA-Stationen</title>
...
if ($remote == '::1' || $remote == '127.0.0.1' ||
    $remote == '134.155.60.86' ||
    // Allow access for be44 - Theke West
    ...
    <h2>Übersicht Bibliotheksbereich Schloss Ehrenhof &ndash; PalMA-Stationen</h2>
...
stations.push(['BE 01', 'http://palma-be-01.bib.uni-mannheim.de/']);
stations.push(['BE 02', 'http://palma-be-02.bib.uni-mannheim.de/']);
...
for (var n = 0; n < stations.length; n++) {
    ...
    <h2>ÜbersichtBibliotheksbereich Schloss Ehrenhof &ndash; PalMA-Stationen</h2>
